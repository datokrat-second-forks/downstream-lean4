...
attribute [ext, grind ext] Equiv.ext
...
@[simp, mfld_simps, grind norm] theorem toFun_as_coe (e : α ≃ β) : e.toFun = e := rfl
...
attribute [simp, grind =] Equiv.symm_trans
...
attribute [simp] Equiv.symm_trans_self Equiv.self_trans_symm
